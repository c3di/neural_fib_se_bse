...
public:
	Volume_Intersector(std::tuple<int, int, int> volume_size_, float threshold, float2* extended_heightfield_gpu, float3* normal_map_gpu, int n_hf_entries, int max_buffer_length = 64, Implementation impl = SINGLE);
	~Volume_Intersector();
