...
from .DirectionalDistributions import *
...
class CBooleanModel:
    ...
    def save_configuration(self,foldername,number=None):
        ...
        config['Geometry'] = {'number of particles': self._Sampled_Particle_Number,
                              'center points': self._Sampled_Centers,
                              'parameters': self._Sampled_Parameters,
                              'orientation (quaternion)': self._Sampled_Rotations,
                              'zxz euler orientation': Euler_Angles,
                              'direction angle orientation': Direction_Angle}
